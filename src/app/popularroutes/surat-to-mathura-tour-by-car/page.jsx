...
const Page = () => {
  ...
  const carouselImageSrc = "/tour/surat-to-mathura-tour-by-car.webp";
        ...
        <div className="blog-page-left"> {/* Changed 'class' to 'className' */}
          <div className="single-blog"> {/* Changed 'class' to 'className' */}
                ...
                <div className="carousel-inner"> {/* Changed 'class' to 'className' */}
                  <div className="carousel-item active"> {/* Changed 'class' to 'className' */}
                    ...
                    <Image
                      ...
                      alt="Surat to Mathura Tour By Car" // Alt text is good
            ...
            <div className="blog-text"> {/* Changed 'class' to 'className' */}
              <p>
                You'll need to arrange your travel from **Surat to Delhi** independently. Our cab service will then pick you up from the airport or railway station in Delhi. From there, your **Mathura Vrindavan tour by car** will officially begin.
              </p>
              <br /> {/* Self-closing br tag */}

              <h2>Book Surat to Mathura Taxi/Cab</h2>

              <p>
                If you are planning to travel to **Mathura from Surat**, booking a taxi or cab is an excellent option. The **Surat to Mathura taxi** fare varies depending on the cab you choose. Booking a **Surat to Mathura cab** will be hassle-free. You can find a cab that is budget-friendly, or if you prefer a luxurious trip, you can opt for more expensive, air-conditioned cabs that offer ample space.
              </p>
              ...
              <div className="gauto-leave-comment"> {/* Changed 'class' to 'className' */}
                ...
                <h2>Distance Covered By Surat To Mathura Cab</h2>
                <p>The distance between **Surat to Mathura** by car is approximately **1109 km**, and the travel time is around **19 to 20 hours**. The distance may change if you alter the route. The time can also differ according to traffic conditions. The time taken to cover the distance also depends on your average speed and any stoppage time during the journey.</p>
                <br /> {/* Self-closing br tag */}
                <h3>Types of Surat To Mathura Taxi Available</h3> {/* Corrected heading for grammar */}
                <p>**Surat To Mathura Taxi** options range from 4-seater to 16-seater. The price of the vehicle also varies according to the passenger capacity and luggage. All our taxis are fully air-conditioned, and the drivers are highly experienced, ensuring your safety throughout the journey.</p>
              </div>
            </div>
          </div>
        </div>
