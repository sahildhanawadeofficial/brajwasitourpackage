    ...
    <>
            ...
            <div className="col-md-6">
              <div className="header-top-right">
                <Link href="mailto:choudharyyogesh752@gmail.com">
                  <FaEnvelope className="icon" /> choudharyyogesh752@gmail.com
                </Link>
      ...
      <div className="marquee">
        <marquee behavior="scroll" direction="left">
          🚩 ब्रजवासी टूर पैकेज में आपका स्वागत है 🚩 84 कोस यात्रा, बरसाना, नंदगांव, गोकुल, वृंदावन, मथुरा और गोवर्धन यात्रा के लिए अभी बुक करें। 🚕 अनुभवी ड्राइवर, स्वच्छ गाड़ियाँ और धार्मिक अनुभव की गारंटी। 📞 संपर्क करें: +91 8126990023 | ✉️ choudharyyogesh752@gmail.com
        </marquee>
      </div>
